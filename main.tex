...
\begin{equation*}
    ...
    \Longleftrightarrow
    \left\{
        \begin{tabular}{@{\hskip0pt} >{$\phantom{}}r<{x_1$} @{\hskip3pt} >{$\phantom{}}r<{x_2$} @{\hskip3pt} >{$\phantom{}}r<{x_3$} @{\hskip3pt} C @{\hskip3pt} C}
...
\begin{align*}
    \begin{gmatrix}[v]
        ...
        -3 & -4 & 1 & 11
        \rowops
            \mult{0}{\cdot 5} % умножить 1 строку на 5
            \mult{1}{\cdot (-2)} % умножить 2 строку на -2
    ...
    \begin{gmatrix}[v]
        ...
        -3 & -4 & 1 & 11
        \rowops
            \mult{1}{\cdot 3} % умножить 2 строку на 3
            \mult{2}{\cdot 5} % умножить 3 строку на 5
    ...
    \begin{gmatrix}[v]
        ...
        -3 & -4 & 1 & 11
        \rowops
            \mult{0}{\cdot 23} % умножить 1 строку на 23
            \mult{1}{\cdot 32} % умножить 2 строку на 32
            \add{1}{0} % прибавить 2 строку к 1
    \end{gmatrix}
    & \longrightarrow
    \begin{gmatrix}[v]
