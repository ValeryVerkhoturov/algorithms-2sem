...
\begin{table}[htb]
    ...
    \resizebox{\textwidth}{!}{
        \begin{tabular}{|*{8}{L|}}
            ...
            -1,5 & -1 & -1,25 &	\phantom{+}2,25 & -3 & -0,6875 & -1,546875 & \phantom{+}2,0625 \\ \hline
        
            -1,5 & -1,25 & -1,375 & \phantom{+}2,25 &	-0,6875	& \phantom{+}0,7031 & \phantom{+}1,581975 & -0,48338125 \\ \hline
        
            -1,25 & -1,375 & -1,3125 & -0,6875 & \phantom{+}0,7031 & -0,0117 & \phantom{+}0,00804375 & -0,00822627 \\ \hline
        
            -1,375 & -1,3125 & -1,3438 & \phantom{+}0,7031 & -0,0117 &	\phantom{+}0,3414 & \phantom{+}0,24003834 & -0,00399438 \\ \hline
        
            -1,3125 & -1,3438 & -1,3282 & -0,0117 & \phantom{+}0,3414 & \phantom{+}0,1642 & -0,00192114 &	\phantom{+}0,05605788 \\ \hline
        
            -1,3125 & -1,3282 & -1,3204 & -0,0117 & \phantom{+}0,1642 & \phantom{+}0,0765 & -0,00089505 & \phantom{+}0,0125613 \\ \hline
        
            -1,3125 & -1,3204 & -1,3165 & -0,0117 & \phantom{+}0,0765 & \phantom{+}0,0329 & -0,00038493 & \phantom{+}0,00251685 \\ \hline
        
            -1,3125 & -1,3165 & -1,3145 & -0,0117 & \phantom{+}0,0329 & \phantom{+}0,0106 & -0,00012402 & \phantom{+}0,00034874 \\ \hline
        
            -1,3125 & -1,3145 & -1,3135 & -0,0117 & \phantom{+}0,0106 & -0,0006 & \phantom{+}0,00000702 & -0,00000636 \\ \hline
        \end{tabular}
    }
...
\begin{table}[htb]
    ...
    \end{tabular}
    \caption{Расчет разностей табличной функции}
    \label{sr2Table}
\end{table}
...
\begin{table}[htb]
    ...
    \begin{tabular}{|*{3}{L|}}
        ...
        i & x_i & y_i \\ \hline
        0 & 2 & -0,0098 \\ \hline
        1 & 3 & -9,27 \times 10^{-5} \approx 0 \\ \hline
        2 & 4 & -1,02 \times 10^{-7} \approx 0 \\ \hline
        3 & 5 & -1,37 \times 10^{-11} \approx 0 \\ \hline
        4 & 6 & -2,3 \times 10^{-16} \approx 0 \\ \hline
        5 & 7 & -4,81 \times 10^{-22} \approx 0 \\ \hline
        6 & 8 & -1,23 \times 10^{-28} \approx 0 \\ \hline
    \end{tabular}
...
\begin{table}[htb]
    ...
    \begin{tabular}{|*{3}{L|}}
        \hline
        n & t_n & y_n \\ \hline
        0 & 0 & \phantom{0}6 \\ \hline
        1 & 1 & \phantom{0}7 \\ \hline
        2 & 2 & \phantom{0}8,333 \\ \hline
        3 & 3 & 10,055 \\ \hline
        4 & 4 & 12,231 \\ \hline
        5 & 5 & 14,936 \\ \hline
        6 & 6 & 18,259 \\ \hline
